...
* [Tim] [Leaderboard](https://insights.linuxfoundation.org/project/presto/contributors?timeRange=custom&start=2026-01-13&end=2026-02-10&widget=contributors-leaderboard)
* [Amit] [Vector search in Presto](https://github.com/prestodb/rfcs/pull/56)
* [Tim] [Dynamic partition pruning](https://github.com/prestodb/rfcs/pull/54)
